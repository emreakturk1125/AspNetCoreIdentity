...
namespace NetCoreIdentity.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          //  cookieBuilder.Expiration = System.TimeSpan.FromMinutes(60);           // Kullanıcı 1 kez login olduktan sonra 60 dk boyunca siteye erişim yapabilecek
            ...
            }).AddPasswordValidator<CustomPasswordValidator>().AddUserValidator<CustomUserValidator>().AddErrorDescriber<CustomIdentityErrorDescriber>().AddEntityFrameworkStores<AppIdentityDbContext>();  // Identity
        }
